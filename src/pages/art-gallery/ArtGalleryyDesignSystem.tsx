...
const ArtGalleryyDesignSystem = () => {
  return (
    <>
      <div className="container pt-8">
        <div className="flex justify-between gap-8 max-lg:flex-col pb-8">
        ...
        <div className="flex gap-4 max-lg:flex-col">
          <div className="w-full xs:w-[16.25rem] max-w-full">
...
export default ArtGalleryyDesignSystem;
